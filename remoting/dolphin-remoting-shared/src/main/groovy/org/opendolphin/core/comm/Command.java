...
public class Command {
    ...
    public static String idFor(Class commandClass) {
        return StringGroovyMethods.minus(StringGroovyMethods.minus(StringGroovyMethods.minus(StringGroovyMethods.minus(commandClass.getName(), commandClass.getPackage().getName()), "."), "Command"), "Notification");
    }
