...
public class ClientListMapper extends ListMapper {
    public ClientListMapper(Dolphin dolphin, ClassRepository classRepository, BeanRepository beanRepository, PresentationModelBuilderFactory builderFactory) {
        super(dolphin, classRepository, beanRepository, builderFactory);
    }

    @Override
    protected String getAddEntryKey() {
        return DolphinConstants.ADD_FROM_SERVER;
    }

    @Override
    protected String getDelEntryKey() {
        return DolphinConstants.DEL_FROM_SERVER;
    }

    @Override
    protected String getSetEntryKey() {
        return DolphinConstants.SET_FROM_SERVER;
    }
